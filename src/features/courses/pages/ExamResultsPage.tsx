    ...
    if (!results) {
        return (
            <div className="h-screen bg-[#F8FAFC] dark:bg-[#0e0e10] flex flex-col items-center justify-center gap-4">
                ...
                <p className="text-slate-500 dark:text-[#d0d0E0] font-medium">Results could not be loaded.</p>
                <button onClick={() => navigate(-1)} className="text-[#0061EF] font-semibold hover:underline">Go Back</button>
            </div>
        );
    }
        ...
        <div className="h-screen bg-[#F8FAFC] dark:bg-[#0e0e10] font-inter flex flex-col overflow-hidden">
            ...
            <div className="bg-white dark:bg-[#1A1A1A] border-b border-slate-200 dark:border-[#2a2a2e] shrink-0 z-20">
                <div className="max-w-7xl mx-auto px-4 md:px-6 py-3.5 flex items-center gap-4">
                    ...
                    <h1 className="text-base font-bold text-slate-800 dark:text-[#E0E0E0]">Exam Results</h1>
                </div>
            </div>
            ...
            <main className="flex-1 max-w-7xl mx-auto w-full flex flex-col lg:flex-row gap-6 p-4 md:p-6 overflow-hidden">
                ...
                <div className="w-full lg:w-[400px] xl:w-[450px] shrink-0 flex flex-col gap-5 overflow-y-auto pr-1 pb-8 custom-scrollbar">
                    ...
                    <div className={`relative overflow-hidden rounded-3xl p-6 flex flex-col items-center text-center border shadow-sm shrink-0 ${passed
                        ...
                        <h2 className="text-2xl font-black text-slate-800 dark:text-[#E0E0E0] mb-4 tracking-tight">
                            {passed ? 'Outstanding! You Passed.' : 'Not Quite There'}
                        </h2>
                    ...
                    <div className="grid grid-cols-2 gap-3 shrink-0">
                        {[
                            { icon: <CheckCircle2 size={18} />, label: 'Correct', value: `${correctCount}/${totalCount}`, color: 'text-green-600 dark:text-green-400', bg: 'bg-green-50 dark:bg-green-500/10' },
                            { icon: <Target size={18} />, label: 'Score', value: `${score}%`, color: 'text-blue-600 dark:text-blue-400', bg: 'bg-blue-50 dark:bg-blue-500/10' },
                            { icon: <Award size={18} />, label: 'Status', value: passed ? 'Passed' : 'Failed', color: passed ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400', bg: passed ? 'bg-green-50 dark:bg-green-500/10' : 'bg-red-50 dark:bg-red-500/10' },
                            { icon: <Clock size={18} />, label: 'Time', value: timeTaken ? formatTime(timeTaken) : '—', color: 'text-purple-600 dark:text-purple-400', bg: 'bg-purple-50 dark:bg-purple-500/10' },
                        ].map((stat, i) => (
                    ...
                    {analytics && (
                        <div className="bg-white dark:bg-[#1A1A1A] rounded-2xl border border-slate-200 dark:border-[#2a2a2e] p-5 shadow-sm shrink-0">
                            <div className="flex items-center gap-2 mb-4">
                                ...
                                <h3 className="font-bold text-sm text-slate-800 dark:text-[#E0E0E0]">Performance Insights</h3>
                            </div>
                            
                            <div className="flex flex-col gap-4">
                                <div>
                                    <div className="flex justify-between text-xs font-bold mb-1.5">
                                        <span className="text-slate-700 dark:text-[#E0E0E0]">Your Score</span>
                                ...
                                <div>
                                    <div className="flex justify-between text-xs font-bold mb-1.5">
                                        <span className="text-slate-500 dark:text-[#d0d0E0]">Class Average</span>
                                ...
                                <div className="grid grid-cols-2 gap-3 mt-2">
                                    <div className="text-center p-3 bg-slate-50 dark:bg-[#0e0e10] rounded-xl border border-slate-100 dark:border-[#2a2a2e]">
                                        <p className="text-[10px] font-semibold text-slate-500 uppercase">Highest Score</p>
                                        <p className="text-lg font-bold text-slate-800 dark:text-[#E0E0E0]">{Math.round(analytics.highestScore ?? 0)}%</p>
                                    </div>
                                    <div className="text-center p-3 bg-slate-50 dark:bg-[#0e0e10] rounded-xl border border-slate-100 dark:border-[#2a2a2e]">
                                        <p className="text-[10px] font-semibold text-slate-500 uppercase">Pass Rate</p>
                    ...
                    <div className="flex-1 flex flex-col bg-white dark:bg-[#1A1A1A] rounded-3xl border border-slate-200 dark:border-[#2a2a2e] shadow-sm overflow-hidden">
                        ...
                        <div className="p-5 border-b border-slate-100 dark:border-[#2a2a2e] bg-slate-50/50 dark:bg-[#111111] shrink-0 flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <h3 className="font-bold text-base text-slate-800 dark:text-[#E0E0E0]">Detailed Answers Breakdown</h3>
                            </div>
                                            ...
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <div className="grid md:grid-cols-2 gap-3">
                                                    ...
                                                    <div className="p-3 rounded-xl bg-white dark:bg-[#1A1A1A] border border-slate-100 dark:border-[#2a2a2e] shadow-sm">
                                                        <span className="text-[11px] font-bold text-slate-400 block mb-1 uppercase tracking-wider">Your Answer</span>
                                                    ...
                                                    {!q.isCorrect && correctAnswersText && (
                                                        <div className="p-3 rounded-xl bg-white dark:bg-[#1A1A1A] border border-green-100 dark:border-green-500/30 shadow-sm">
                                                            <span className="text-[11px] font-bold text-slate-400 block mb-1 uppercase tracking-wider">Correct Answer</span>
