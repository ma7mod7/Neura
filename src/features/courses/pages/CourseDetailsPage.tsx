                        ...
                        <div className="flex-1 max-w-3xl">
                            ...
                            <div className="flex flex-wrap items-center gap-6 text-sm text-slate-300">
                                <div className="flex items-center gap-1 text-yellow-400">
                                    ...
                                    <span className="text-slate-400 underline ml-1 dark:text-[#d0d0E0]">({courseMetaData?.totalReviews} ratings)</span>
                                </div>
                                <div className="flex items-center gap-2">
                                    <Users size={18} />
                                    <span className="dark:text-[#d0d0E0]">{courseMetaData?.numberOfStudents} students</span>
                                </div>
                                <div className="flex items-center gap-2">
                                    <Clock size={18} />
                                    <span className="dark:text-[#d0d0E0]">45h Total</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                    ...
                    <div className="lg:col-span-8 flex flex-col gap-10">
                        ...
                        <section>
                            ...
                            <p className="text-slate-500 text-sm mb-6 dark:text-[#E0E0E0]">{CourseContent?.sections.length} sections • {CourseContent?.sections.reduce((total, section) => total + section.lessons.length, 0)} lessons • {CourseContent?.hours} total hour</p>
                            ...
                            <div className="bg-white border border-slate-200 rounded-[1rem] p-6 shadow-sm dark:bg-[#1A1A1A] dark:border-[#2a2a2e]">
                                ...
                                <div className="flex items-center gap-4 mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-slate-500 dark:text-[#d0d0E0]">{InstructorData?.headline}</p>
                                    </div>
                                </div>
                            ...
                            <div className="bg-white border border-slate-200 rounded-[1rem] p-6 shadow-sm dark:bg-[#1A1A1A] dark:border-[#2a2a2e]">
                                ...
                                <div className="flex flex-col gap-4">
                                    ...
                                    <div className="flex items-center justify-between text-sm">
                                        ...
                                        <span className="font-semibold text-slate-800 dark:text-[#E0E0E0]">{CourseContent?.hours} hours</span>
                                    </div>
                                </div>
